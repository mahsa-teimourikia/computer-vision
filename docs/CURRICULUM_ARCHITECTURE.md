...
| A04 | Embodied Vision & Vision-Language-Action Models | Advanced | Egocentric observations, active perception, robot state/action schemas, behavior cloning, diffusion policies, VLA adaptation, manipulation, navigation, and authorization boundaries | LeRobot, PyTorch, open VLA checkpoints; MuJoCo/ManiSkill where justified | Language-conditioned simulated workcell task with bounded action and realized-outcome verification | A01, A03, I01, I06 |
