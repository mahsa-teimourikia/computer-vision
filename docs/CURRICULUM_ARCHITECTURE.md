...
| B04 | Self-Supervised Visual Representation Learning | Beginner | Contrastive learning, masked modeling, collapse, probing, embeddings | PyTorch, torchvision, Transformers/timm, FAISS | Industrial representation learning from a large unlabeled archive | B03 |
...
| I02 | [Multimodal Reasoning & Verification](../curriculum/intermediate/02-multimodal-reasoning-verification/README.md) | Intermediate | Task DAGs, bound evidence, deterministic tools, counterfactual and contradiction tests, uncertainty, checked claims | Python, NumPy, pandas, typed tool contracts | Evidence-backed maintenance reasoning with review-required states | I01 |
...
| A01 | 3D Vision & Spatial Intelligence | Advanced | Frames, calibration, epipolar geometry, stereo/monocular depth, triangulation, pose, point-cloud reconstruction, metric reasoning, uncertainty | NumPy, SciPy; OpenCV/Open3D and learned geometry optional | Recover and evaluate metric workcell geometry with a held-out spatial decision | B03, B05, B06, B08, I05, I06 |
| A02 | Neural Rendering & 3D Scene Representations | Advanced | Rays, differentiable volume rendering, NeRF, held-out views, Gaussian projection/splatting, geometry disagreement, density control | NumPy/SciPy core; Nerfstudio, gsplat, Instant-NGP, original 3DGS, PyTorch3D optional | Governed neural rendering of a calibrated valve-cell capture | A01 |
| A03 | Dynamic Scenes & World Models | Advanced | Persistent state, partial observability, action-conditioned dynamics, 4D representations, stochastic futures, rollout drift, physical checks, planning exploitation | NumPy/pandas/Pillow/scikit-learn core; DreamerV3, Cosmos 3, Dynamic 3D Gaussians, Genie 3 optional | Source-held-out industrial-workcell world-model evidence | A02, B08, I02, I05, I06 |
| A04 | Embodied Vision & Vision-Language-Action Models | Advanced | Timestamped observations, proprioception, embodiment contracts, goal grounding, affordances, action spaces, behavior cloning, chunking, VLA families, independent feasibility, feedback, recovery, and authorization boundaries | NumPy/pandas/scikit-learn core; LeRobot, OpenVLA/openpi/GR00T, MuJoCo/ManiSkill optional | Language-conditioned simulated workcell with bounded proposals, simulation-only permits, postcondition verification, and held-out embodiment evidence | A01, A03, I01, I06 |
| A05 | Spatial Memory, Scene Graphs & Navigation | Advanced | Localization drift, occupancy evidence, unknown space, object identity, temporal memory, relation provenance, scene/place graphs, typed queries, A*, topology, active perception, replanning, poisoning defense, and plan invalidation | NumPy/pandas/NetworkX core; Open3D, Nav2, Hydra, Habitat-Lab, and open-vocabulary 3D memory systems optional | Build and evaluate governed persistent memory for an industrial inspection robot with Site C reporting-only | I02, I04, A01, A03, A04 |
| A06 | Embodied AI in simulation | Advanced | Closed-loop policies, navigation/manipulation, feedback, recovery, sim-to-real | MuJoCo, ManiSkill; Habitat/Isaac Lab by scenario | Observe-plan-act-correct warehouse task | A04, A05, I07 |
