...
4. **Embodied Vision & Vision-Language-Action Models** — egocentric observation, robot perception, active sensing, structured actions, manipulation, navigation, and governed VLA architectures.
